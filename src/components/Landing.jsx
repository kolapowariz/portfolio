    ...
    <div className='w-full mx-auto lg:w-[95%] lg:mx-auto bg-[#ffbb8b] p-5 lg:m-5'>
      ...
      <main className='mx-4 my-4'>
        <section id='#' className='flex flex-col lg:flex-row lg:justify-between lg:items-start'>
          ...
          <section>
            <img src={Myself2} alt="Kolapo Wariz" loading='lazy' className='block mt-6 h-72 w-72 mx-auto rounded-full object-cover' />
      ...
      <footer>
        <div className='flex justify-center'>
          ...
          <img src={ig} alt="Instagram Account" />
          <img src={tw} alt="X Account" />
          <img src={ln} alt="Facebook Account" />
        </div>
